...
class InterfacePlateau:
    def __init__(self, parent):
        ...
        self.fenetre.title("Theoretical Number of Plates")
        ...
        tk.Label(hdr, text="Theoretical Number of Plates",
                 font=("Segoe UI", 20, "bold"), fg=TEXT_PRI, bg=BG).pack(anchor="w", pady=(2,1))
        tk.Label(hdr, text="N = 16 (tR / wb)² via retention time and peak width",
    ...
    def _calculer_ligne(self):
        ...
        try:
            res = theorical_plates_one(tR, wb)
            self.label_resultat.config(text=f"N = {res:.2f} plates")
